...
<form method="post" rel="pagerForm" action="<c:url value='/admin/audit/listAudit.do'/>" onsubmit="return navTabSearch(this)">
<div class="pageHeader">
	<div class="searchBar">
		<ul class="searchContent">
			...
			<li>
				<label>资料完整：</label>
				<select name="infoComplete" style="width:150px">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" target="navTab" href="<c:url value='/admin/audit/detailAudit/{slt_userId}'/>" title="资料审核"><span>审核</span></a></li>
