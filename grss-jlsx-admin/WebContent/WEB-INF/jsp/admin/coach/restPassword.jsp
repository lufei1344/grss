...
<form action="<c:url value='/admin/coach/updatePassword?navTabId=listCoachNav&callbackType=closeCurrent'/>" method="post" class='required-validate pageForm' onsubmit="return iframeCallback(this, navTabAjaxDone);">
